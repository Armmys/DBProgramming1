...
public class LAB12 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            preparedStatement.setString(1, "65130500044");
            preparedStatement.setString(2, "Pitichai");
            preparedStatement.setString(3, "Limsuchalee");
            preparedStatement.setString(4, "pitichai.lims@mail.kmutt.ac.th");
